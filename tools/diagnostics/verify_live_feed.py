...
Cron (09:25 + 13:00 IST, Mon-Fri):
  25 9  * * 1-5 cd /root/aac && set -a && . ./.env && set +a && venv/bin/python tools/diagnostics/verify_live_feed.py >> logs/verify_feed.log 2>&1
  0  13 * * 1-5 cd /root/aac && set -a && . ./.env && set +a && venv/bin/python tools/diagnostics/verify_live_feed.py >> logs/verify_feed.log 2>&1
"""
