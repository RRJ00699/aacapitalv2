...
Dry-run by default. --apply writes (normalise + fill listing_date + revert mismatches).
  ...
  python tools/diagnostics/ipo/verify_resolved_symbols.py                 # report only
  python tools/diagnostics/ipo/verify_resolved_symbols.py --apply         # write fixes
  python tools/diagnostics/ipo/verify_resolved_symbols.py --tol 7         # looser alignment window
"""
