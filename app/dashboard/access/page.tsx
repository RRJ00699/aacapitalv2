...
const C = { bg:"var(--t-bg)", s:"var(--t-surface)", bd:"var(--t-border)", tx:"var(--t-text)", mt:"var(--t-meta)", dim:"var(--t-dim)",
  gr:"var(--t-green)", grB:"var(--t-greenBg)", grD:"var(--t-greenBd)", rd:"var(--t-red)", rdB:"var(--t-redBg)", rdD:"var(--t-redBd)", gy:"var(--t-grayBg)" };
...
function Access() {
  ...
  return (
    <div style={{padding:"18px clamp(14px,4vw,20px)",background:C.bg,minHeight:"100vh",maxWidth:760,margin:"auto",
    ...
    <h1 style={{fontFamily:"var(--f-display)",letterSpacing:-0.3,fontSize:19,fontWeight:800,margin:"0 0 2px"}}>Access requests</h1>
