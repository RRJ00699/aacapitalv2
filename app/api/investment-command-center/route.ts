...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    fundamentals: {
      roce: n(pick(f.roce, cm.roce, 0)), roe: n(pick(f.roe, cm.roe, 0)), sales_cagr_3y: n(pick(f.sales_growth_3y, f.sales_growth, 0)), eps_cagr_3y: n(pick(f.eps_growth_3y, f.eps_cagr_3y, 0)), debt_equity: n(pick(f.debt_equity, 0)), interest_cover: n(pick(f.interest_coverage, 0)), pat_growth: n(pick(f.profit_growth, 0)),
    },
    technical: {
