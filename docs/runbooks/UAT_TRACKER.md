...
| D1 | Complete Details view v1 shipped (payload-complete, honest gaps) | DONE this branch | see docs/specifications/DETAILS_AND_REVIEW.md matrix | J11/J12 + test_listing_review |
