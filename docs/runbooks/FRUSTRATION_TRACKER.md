...
- **New golden columns hid inside CREATE IF NOT EXISTS** - 87/87 'applied'
  while creating nothing on the existing durable table; the miner kept
  skipping. Durable-table fields ship as ALTERs, always (now guarded).
