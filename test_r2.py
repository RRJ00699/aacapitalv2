#!/usr/bin/env python3
"""Unit tests for r2.py — no network, no creds, no DB. `python test_r2.py`.
Covers key/url derivation, url parsing, and the no-op degradation when R2 is unconfigured."""
import os, sys
