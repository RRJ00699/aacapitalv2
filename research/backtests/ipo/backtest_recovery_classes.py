...
Usage:
  python research/backtests/ipo/backtest_recovery_classes.py
  python research/backtests/ipo/backtest_recovery_classes.py --min-size-cr 200 --csv recovery.csv
  python research/backtests/ipo/backtest_recovery_classes.py --discount-max 0   # how deep a discount counts
"""
