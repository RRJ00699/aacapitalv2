...
Usage:
  python research/backtests/ipo/analyze_listing_day.py --symbol TURTLEMINT
  python research/backtests/ipo/analyze_listing_day.py --auto-today          # all symbols still inside their anchor lock-in window
  python research/backtests/ipo/analyze_listing_day.py --symbol X --date 2026-06-29
"""
