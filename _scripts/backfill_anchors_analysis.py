...
resolves via report 82 (~IPO id) — but most rows already carry it.
  ...
  python _scripts/backfill_anchors_analysis.py --limit 5           # test
  python _scripts/backfill_anchors_analysis.py --apply             # full
  python _scripts/backfill_anchors_analysis.py --test-only         # backtest
"""
