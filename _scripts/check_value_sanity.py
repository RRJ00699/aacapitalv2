...
violations — only PRESENT values are judged.
  python _scripts/check_value_sanity.py                # report; exit 1 on any HARD violation
  python _scripts/check_value_sanity.py --fail-on-warn
  python _scripts/check_value_sanity.py --table ipo_consolidated
Needs DATABASE_URL.
"""
