...
def main():
    ...
    if not a.apply:
        ...
        print("  1) download_sebi_rhps_playwright.py --pages 1 --max 10  (newest page, max 10 new)")
        ...
        return
    ok = run("download", ["_scripts/download_sebi_rhps_playwright.py", "--pages", "1", "--max", "10"])
